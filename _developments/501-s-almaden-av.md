...
- id: MP22-012
  ...
  - 26431006
  address: 501 S Almaden Ave, San Jose, CA 95110
  description: SB 35 Ministerial Permit to allow the demolition of an existing surface parking lot, and allow the construction
    of an eight-story affordable housing apartment building consisting of 53 units, including one manager’s unit, studios,
    one-, two-, and three-bedroom apartment units, restricted to residents earning between 30 to 60 percent AMI. The project
    will remove 12 non-ordinance-size trees and requires State Density Bonus incentives for one concession and four waivers,
    on a 0.27-gross-acre site.
  contacts:
  - name: Michelle Williams
    company: Satellite Affordable Housing Associates
- id: PRE22-012
