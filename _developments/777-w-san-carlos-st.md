...
phase: Approved
geometry:
  lat: 37.32428650586503
  lng: -121.90539065895328
permits:
- id: AD25-550
  status: Approved
  initial_date: 2025-10-14
  final_date: 2025-10-22
  apn:
  - 26139045
  address: 777 W San Carlos St, San Jose, CA 95126
  description: "Permit adjustment to modify the previously approved metal panels to fiber cement panels. The joint pattern, colors, and all other materials will remain the same."
  contacts:
  - name: Molly Bartlett
    company: DANCO BUILDERS
- id: H20-030
  status: Approved
